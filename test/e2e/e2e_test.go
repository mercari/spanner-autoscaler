...
import (
	...
	"github.com/mercari/spanner-autoscaler/test/utils"
)
...
var _ = Describe("Manager", Ordered, func() {
	...
	Context("Manager", func() {
		...
		It("should have CA injection for SpannerAutoscaler conversion webhook", func() {
			By("checking CA injection for SpannerAutoscaler conversion webhook")
			verifyCAInjection := func(g Gomega) {
				cmd := exec.Command("kubectl", "get",
					"customresourcedefinitions.apiextensions.k8s.io",
					"spannerautoscalers.spanner.mercari.com",
