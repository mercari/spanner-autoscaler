...
var _ = DescribeTable("Calculate Desired Processing Units",
	...
	Entry("should not scale", 25, 200, 30, 100, 1000, 2000, 0, 200),
	Entry("should scale up 1", 50, 300, 30, 100, 1000, 2000, 0, 600),
	Entry("should scale up 2", 50, 1000, 30, 1000, 10000, 2000, 0, 2000),
	Entry("should scale up 3", 50, 900, 40, 100, 5000, 2000, 0, 2000),
	Entry("should scale down 1", 30, 500, 50, 100, 10000, 2000, 0, 400),
	Entry("should scale down 2", 30, 5000, 50, 1000, 10000, 2000, 0, 4000),
	Entry("should scale down 3", 25, 1000, 65, 300, 10000, 800, 0, 400),
	Entry("should scale down 4", 25, 800, 65, 300, 10000, 800, 0, 400),
	Entry("should scale down 5", 25, 700, 65, 300, 10000, 800, 0, 300),
	Entry("should scale up to max PUs 1", 50, 300, 30, 100, 400, 2000, 0, 400),
	Entry("should scale up to max PUs 2", 50, 3000, 30, 1000, 4000, 2000, 0, 4000),
	Entry("should scale down to min PUs 1", 0, 500, 50, 100, 1000, 2000, 0, 100),
	Entry("should scale down to min PUs 2", 0, 5000, 50, 1000, 10000, 5000, 0, 1000),
	Entry("should scale down to min PUs 3", 0, 5000, 50, 100, 10000, 5000, 0, 100),
	Entry("should scale down with ScaledownStepSize 1", 30, 10000, 50, 5000, 10000, 2000, 0, 8000),
	Entry("should scale down with ScaledownStepSize 2", 30, 10000, 50, 5000, 12000, 200, 0, 9000),
	Entry("should scale down with ScaledownStepSize 3", 30, 10000, 50, 5000, 12000, 100, 0, 9000),
	Entry("should scale down with ScaledownStepSize 4", 30, 10000, 50, 5000, 12000, 900, 0, 9000),
	Entry("should scale down with ScaledownStepSize 5", 25, 2000, 65, 300, 10000, 500, 0, 1000),
	Entry("should scale down with ScaledownStepSize 6", 25, 2000, 65, 300, 10000, 800, 0, 1000),
	Entry("should scale down with ScaledownStepSize 7", 25, 1000, 65, 300, 10000, 500, 0, 500),
	Entry("should scale down with ScaledownStepSize 8", 20, 800, 75, 300, 10000, 200, 0, 600),
	Entry("should scale down with ScaledownStepSize 9", 25, 2000, 50, 300, 10000, 500, 0, 2000),
	Entry("should scale down with ScaledownStepSize 10", 25, 2000, 50, 300, 10000, 1000, 0, 2000),
	Entry("should scale down with ScaledownStepSize 11", 25, 2000, 70, 300, 10000, 400, 0, 1000),
