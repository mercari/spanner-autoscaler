...
func (in *ActiveManualScaling) DeepCopyInto(out *ActiveManualScaling) {
	*out = *in
	if in.ExpiresAt != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ActiveManualScaling.
func (in *ActiveManualScaling) DeepCopy() *ActiveManualScaling {
	if in == nil {
		return nil
	}
	out := new(ActiveManualScaling)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CPUWindowMetric) DeepCopyInto(out *CPUWindowMetric) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CPUWindowMetric.
func (in *CPUWindowMetric) DeepCopy() *CPUWindowMetric {
	if in == nil {
		return nil
	}
	out := new(CPUWindowMetric)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ScaleConfig) DeepCopyInto(out *ScaleConfig) {
	*out = *in
	...
	out.ScaledownStepSize = in.ScaledownStepSize
	if in.ScaledownInterval != nil {
		in, out := &in.ScaledownInterval, &out.ScaledownInterval
		*out = new(v1.Duration)
		**out = **in
	}
	out.ScaleupStepSize = in.ScaleupStepSize
	if in.ScaleupInterval != nil {
		in, out := &in.ScaleupInterval, &out.ScaleupInterval
		*out = new(v1.Duration)
		**out = **in
	}
	if in.ScaledownAllowedTimes != nil {
		in, out := &in.ScaledownAllowedTimes, &out.ScaledownAllowedTimes
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	...
	if in.MetricWindows != nil {
		in, out := &in.MetricWindows, &out.MetricWindows
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
func (in *SpannerAutoscalerStatus) DeepCopyInto(out *SpannerAutoscalerStatus) {
	*out = *in
	...
	if in.CurrentCPUWindowMetrics != nil {
		in, out := &in.CurrentCPUWindowMetrics, &out.CurrentCPUWindowMetrics
		*out = make([]CPUWindowMetric, len(*in))
		copy(*out, *in)
	}
	if in.ActiveManualScaling != nil {
		in, out := &in.ActiveManualScaling, &out.ActiveManualScaling
		*out = new(ActiveManualScaling)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SpannerManualScaling) DeepCopyInto(out *SpannerManualScaling) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SpannerManualScaling.
func (in *SpannerManualScaling) DeepCopy() *SpannerManualScaling {
	if in == nil {
		return nil
	}
	out := new(SpannerManualScaling)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *SpannerManualScaling) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SpannerManualScalingList) DeepCopyInto(out *SpannerManualScalingList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]SpannerManualScaling, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SpannerManualScalingList.
func (in *SpannerManualScalingList) DeepCopy() *SpannerManualScalingList {
	if in == nil {
		return nil
	}
	out := new(SpannerManualScalingList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *SpannerManualScalingList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SpannerManualScalingSpec) DeepCopyInto(out *SpannerManualScalingSpec) {
	*out = *in
	if in.ScaleupStepSize != nil {
		in, out := &in.ScaleupStepSize, &out.ScaleupStepSize
	...
	if in.ScaledownStepSize != nil {
		in, out := &in.ScaledownStepSize, &out.ScaledownStepSize
		*out = new(intstr.IntOrString)
		**out = **in
	}
	if in.ScaledownInterval != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SpannerManualScalingSpec.
func (in *SpannerManualScalingSpec) DeepCopy() *SpannerManualScalingSpec {
	if in == nil {
		return nil
	}
	out := new(SpannerManualScalingSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SpannerManualScalingStatus) DeepCopyInto(out *SpannerManualScalingStatus) {
	*out = *in
	if in.AppliedAt != nil {
	...
	if in.ReachedAt != nil {
		in, out := &in.ReachedAt, &out.ReachedAt
		*out = (*in).DeepCopy()
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SpannerManualScalingStatus.
func (in *SpannerManualScalingStatus) DeepCopy() *SpannerManualScalingStatus {
	if in == nil {
		return nil
	}
	out := new(SpannerManualScalingStatus)
	in.DeepCopyInto(out)
	return out
}
